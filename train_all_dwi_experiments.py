"""
train_all_dwi_experiments.py - Complete DWI scratch training orchestrator

Handles:
- 4 Experiments: baseline, mkdc, ds, mkdc_ds
...
# Experiment configurations (matching T1 training structure)
EXPERIMENTS = [
    {
...
def print_status_summary(status_dict):
    ...
    print("\n" + "="*80)
    print("DWI EXPERIMENT STATUS SUMMARY")
    print("="*80)
...
def main():
    ...
    print("\n" + "="*80)
    print("DWI SCRATCH TRAINING - ALL 4 CONFIGURATIONS")
    print("="*80)
    ...
    for exp in EXPERIMENTS:
        print(f"  {exp['name']}: MKDC={exp['use_mkdc']}, DS={exp['deep_supervision']}")
    print("="*80)
    ...
    print("\n" + "="*80)
    print("🎉 ALL DWI EXPERIMENTS COMPLETE!")
    print("="*80)
    ...
    summary_file = Path(OUTPUT_DIR) / 'dwi_scratch_complete_summary.json'
