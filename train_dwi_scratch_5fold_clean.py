...
def main():
    parser = argparse.ArgumentParser(description='DWI 5-Fold Cross-Validation Training on ISLES')
    ...
    parser.add_argument('--output-dir', type=str, 
                       default='/home/pahm409/dwi_isles_5fold_cv')
    ...
    print("\n" + "="*70)
    print(f"DWI 5-FOLD CV TRAINING - FOLD {args.fold}")
    ...
    exp_dir = Path(args.output_dir) / config_name / f'fold_{args.fold}' / f'exp_{timestamp}'
    ...
    val_dataset = PatchDatasetWithCenters(
        ...
        fold=args.fold,
        patch_size=tuple(args.patch_size),
        patches_per_volume=20,  # OPTIMIZED: 20 instead of 100 for faster validation
        augment=False,
    ...
    val_loader = DataLoader(
        val_dataset, 
        batch_size=16,  # OPTIMIZED: Doubled for faster validation
        shuffle=False, 
    ...
    print("\n" + "="*70)
    print(f"Starting DWI 5-Fold CV Training")
    print("="*70 + "\n")
