"""
train_single_fold_all_runs.py - Train ALL 3 runs for a specific fold

Usage:
    python train_single_fold_all_runs.py --fold 0    # Runs fold 0: run_0, run_1, run_2
    python train_single_fold_all_runs.py --fold 1    # Runs fold 1: run_0, run_1, run_2
...
OUTPUT_DIR = "/home/pahm409/ablation_ds_main_only1"
GPU_ID = "4"
...
def run_single_experiment(exp_config, fold, run, output_dir, gpu_id, resume_checkpoint=None):
    ...
    cmd = [
        'python', 'corr_optimized.py',  # Use optimized version
        '--fold', str(fold),
        '--run-id', str(run),
        '--epochs', str(EPOCHS),
...
def main():
    parser = argparse.ArgumentParser(description='Train all runs for a specific fold')
    ...
    print("\n" + "="*80)
    print(f"FOLD {fold} - ALL RUNS TRAINING")
    print("="*80)
