...
ISLES_DIR = "/home/pahm409/preprocessed_stroke_foundation/ISLES2022"
OUTPUT_FILE = "isles_splits_5fold.json"
...
print(f"  Train cases in fold_0: {len(loaded['fold_0']['ISLES2022']['train'])}")
