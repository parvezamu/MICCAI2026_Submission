...
Enhanced unified segmentation training script with DEEP SUPERVISION:
...
NEW: Deep Supervision option for better gradient flow and performance
...
def main():
    parser = argparse.ArgumentParser(description='Enhanced Unified Segmentation with Deep Supervision')
