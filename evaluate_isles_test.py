...
UPDATED: Accept single checkpoint path instead of directory
"""
...
def evaluate_test_set(model, test_dataset, device, patch_size=(96, 96, 96), 
    ...
    # Create DataLoader with safe settings
    ...
    for vol_idx in tqdm(sorted(volume_data.keys()), desc='Reconstructing'):
        ...
        # STEP 1: Reconstruct in resampled space
        ...
        # STEP 2: Get original ISLES data
        try:
        ...
        # STEP 4: Get ground truth from original files
