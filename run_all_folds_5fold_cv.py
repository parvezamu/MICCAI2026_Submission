#!/usr/bin/env python3
"""
Master script to run all 5 folds for DWI 5-Fold Cross-Validation
"""
...
OUTPUT_DIR = "/home/pahm409/dwi_isles_5fold_cv"
GPU_ID = "0"
FOLDS = [0, 1, 2, 3, 4]
...
def run_fold(fold, gpu_id):
    ...
    cmd = [
        'python', 'run_fold_5fold_clean.py',
        '--fold', str(fold),
        '--gpu', str(gpu_id)
    ]
...
def main():
    parser = argparse.ArgumentParser(description='Run complete 5-fold cross-validation for DWI')
    ...
    print("\n" + "="*80)
    print("DWI 5-FOLD CROSS-VALIDATION - MASTER RUNNER")
    print("="*80)
    ...
    print(f"  Estimated total time: ~30-50 hours")
    print("="*80 + "\n")
    ...
    print("\n" + "="*80)
    print("DWI 5-FOLD CROSS-VALIDATION COMPLETE!")
    print("="*80)
    print(f"Summary:")
