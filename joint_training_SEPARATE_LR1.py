...
Joint training with SEPARATE learning rates:
- DWI: lr=0.0001 (pretrained, learns slower)
- ADC: lr=0.001 (random init, needs higher LR)
"""
...
def main():
    ...
    print("="*80)
    print("JOINT TRAINING - FIXED LOSS FUNCTION")
    print("="*80)
