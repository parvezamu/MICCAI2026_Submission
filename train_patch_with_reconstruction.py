...
def main():
    ...
    parser.add_argument('--output-dir', type=str, 
                       default='/home/pahm409/patch_reconstruction_experiments')
    ...
    parser.add_argument('--save-nifti-every', type=int, default=10,
                       help='Save NIfTI files every N epochs')
    ...
    print("\n" + "="*70)
    print("PATCH TRAINING WITH FULL-VOLUME RECONSTRUCTION + NIFTI SAVING")
    print("="*70)
    ...
    exp_dir = Path(args.output_dir) / f'patch_recon_{timestamp}'
    ...
    for epoch in range(args.epochs):
        ...
        if (epoch + 1) % args.validate_recon_every == 0 or epoch == 0:
            ...
            # Save NIfTI files every N epochs
